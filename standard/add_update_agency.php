<?php 
                    ...
                    if(isset($_POST) && !empty($_POST)){
                        ...
                        $sql ="UPDATE type_tb SET group_name= ?  WHERE agency_id = ? ";
                        $params = array($_POST["group_name"],$_POST["agency_id"]);
    ...
    <div class="container  tab-content font">
        <div id="home" class="container-fluid tab-pane active m-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?=$result['agency_name'] ?>" name="agency_name"
                            placeholder="ชื่อหน่วยงาน :" required autocomplete="off">
                    </div>
