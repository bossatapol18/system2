...
if(isset($_POST['save_multiple_data']))
{
    ...
    foreach($group_name as $index => $group_name)
    {
      $group_name = $group_name;
        ...
        $query = "INSERT INTO standard_tb (standard_mandatory,group_name,standard_meet,standard_tacking,standard_number,standard_detail,standard_note) 
        VALUES ($standard_mandatory,$group_name,$standard_meet,$standard_tacking,$standard_number,$standard_detail,$standard_note)";
