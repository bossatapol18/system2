<?php 
                    ...
                    if(isset($_POST) && !empty($_POST)){
                        ...
                        $sql ="UPDATE type_tb SET group_name= ?  WHERE group_id = ? ";
    ...
    <div class="container  tab-content font">
        <div id="home" class="container-fluid tab-pane active m-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?=$result['group_name'] ?>" name="group_name"
                            placeholder="ชื่อกลุ่ม :" required autocomplete="off">
                    </div>
